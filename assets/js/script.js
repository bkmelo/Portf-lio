...
async function getAboutGithub() {
  try {
    const resposta = await fetch('https://api.github.com/users/bkmelo');
      ...
      <article class="about-content">
        ...
        <div class="about-buttons-data">
          <div class="buttons-container">
            ...
            <a href="./assets/docs/CURRICULO.2026.1.pdf" target="_blank" class="botao-outline">Currículo</a>
          </div>
...
async function getProjectsGithub() {
  try {
    const resposta = await fetch(
      'https://api.github.com/users/bkmelo/repos?sort=updated&per_page=6'
    );
