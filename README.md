...
O **Projeto Portfólio Pessoal** é um **site profissional moderno**, desenvolvido com **HTML, CSS e JavaScript**, com o objetivo de apresentar informações sobre mim a desenvolvedora, meus projetos e formas de contato de maneira clara, interativa e responsiva.
